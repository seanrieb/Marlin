...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PC13           // Set a custom pin for the controller fan
  ...
  #define CONTROLLERFAN_SPEED_IDLE       76 // (0-255) Idle speed, used when motors are disabled
