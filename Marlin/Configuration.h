...
#define STRING_CONFIG_H_AUTHOR "Rieb Technologies" // Who made the changes.
...
#define MACHINE_UUID "3137108c-db45-4a60-acf7-daf588fb6338"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.8, -40.5, -1.72 }
